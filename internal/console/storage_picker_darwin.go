...
// chooseStorageDirectory runs on the supplier's desktop, so macOS can return a real absolute path rather than the privacy-preserving relative filename a browser file input exposes.
