...
const en = {
  ...
  'models.tableScrollHint': 'Swipe horizontally to see all model details',
  ...
  'traffic.tableScrollHint': 'Swipe horizontally to see all request details',
...
const zh: Record<MessageKey, string> = {
  ...
  'models.tableScrollHint': '左右滑动查看全部模型信息',
  ...
  'traffic.tableScrollHint': '左右滑动查看全部请求信息',
